...
export function NavigationBar() {
  ...
  return (
    <div className="flex p-4 justify-between w-full border-b border-gray-500">
      {/* Left: NSUTTHON Logo (Text hidden on mobile) */}
      <Link to="/">
        <div className="relative active:scale-95 hover:scale-95 transition-all cursor-grab z-20 pt-2 flex items-center">
          <svg
            ...
            viewBox="0 0 24 24"
            fill="none"
            className="sm:mr-2 stroke-black dark:stroke-white h-6 w-6"
          >
            <path
          ...
          <h1 className="font-raleway text-2xl font-black tracking-tight hidden sm:block">NSUTTHON</h1>
        </div>
      </Link>
